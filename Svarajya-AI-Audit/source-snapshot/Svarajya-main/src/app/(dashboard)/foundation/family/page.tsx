        ...
        try {
            ...
            if (response.ok) {
                ...
                if (Array.isArray(profileData)) {
                    ...
                    ): FamilyMember["accessRole"] => {
                        if (accessLevel === "write") return "Executor";
                        if (accessLevel === "read") return "Viewer";
                        if (accessLevel === "emergency") return "Emergency-only";
                        return "None";
                    };
                    ...
                    const loadedMembers: FamilyMember[] = profileData.map((member: any) => ({
                        ...
                        accessRole: mapAccessRole(member.accessLevel),
                    }));
