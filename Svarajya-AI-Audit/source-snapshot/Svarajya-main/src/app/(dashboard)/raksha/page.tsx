...
export default function RakshaModule() {
  ...
  const hasLifeHealth =
    selectedPolicies.includes("term") && selectedPolicies.includes("health");
      ...
      <div className="relative z-10 flex flex-col flex-1 p-6 pb-28">
        ...
        <div className="flex-1 flex flex-col">
          <MicroLearningWrapper
            ...
            quizOptions={[
              {
                label: "To get a return on investment over time",
                isCorrect: false,
              },
              {
                label: "To protect the Kosh from critical, sudden depletion",
                isCorrect: true,
              },
            ...
            : <motion.div
              ...
              >
                <div className="text-center space-y-5 w-full max-w-sm">
                  <Shield
                    className={`w-16 h-16 mx-auto ${hasLifeHealth ? "text-rajya-success" : "text-rajya-danger"}`}
                  />
                  <h3 className="text-xl text-rajya-text font-display">
                    Fortress Status
                  </h3>

                  {hasLifeHealth ?
                    <p className="text-rajya-success/90 text-sm bg-rajya-success/10 p-5 rounded-xl border border-rajya-success/20 leading-relaxed">
                      Your core walls (Life & Health) are standing. The
                      foundation is secure against major sieges.
                    </p>
                  : <p className="text-rajya-danger/90 text-sm bg-rajya-danger/10 p-5 rounded-xl border border-rajya-danger/20 leading-relaxed">
                      CRITICAL CRACK DETECTED: Without both Term and Health
                      shields, your entire Kosh remains exposed to a single
                      catastrophic event.
                    </p>
                  }
                </div>
                ...
                <button
                  ...
                  className="w-full max-w-sm flex items-center justify-center gap-2 bg-rajya-accent text-black py-4 rounded-xl font-bold font-display uppercase tracking-widest hover:opacity-90 transition-opacity"
                >
                  Acknowledge & Seal
                </button>
              </motion.div>
        ...
        <div className="mt-8 pt-6 border-t border-white/5">
          ...
          <VideoTutorialPlaceholder
            youtubeId="3Ob3stTkGLs"
            label="Term insurance & health insurance explained for beginners"
          />
        </div>
        ...
        {policies.length > 0 && (
          ...
          >
            ...
            >
              <List className="w-5 h-5 text-rajya-accent" />
